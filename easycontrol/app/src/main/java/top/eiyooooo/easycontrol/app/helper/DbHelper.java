...
public class DbHelper extends SQLiteOpenHelper {
  ...
  private ContentValues getValues(Device device) {
    ...
    values.put("deviceOrder", device.order);
  ...
  private Device getDeviceFormCursor(Cursor cursor) {
    return new Device(
      ...
      cursor.getColumnIndex("clipboardSync") != -1 && cursor.getInt(cursor.getColumnIndex("clipboardSync")) == 1,
      ...
      cursor.getColumnIndex("deviceOrder") == -1 ? 0 : cursor.getInt(cursor.getColumnIndex("deviceOrder")),
